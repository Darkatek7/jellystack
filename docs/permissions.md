...
Google Play can show permissions from older published versions in its historical “all versions” view. The manifest of the current 0.15.0 bundle is authoritative for current installs.
